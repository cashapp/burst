...
```kotlin
dependencies {
  testImplementation("app.cash.burst:burst-coroutines:2.12.1")
  ...
}
```
...
buildscript {
  ...
  dependencies {
    classpath("app.cash.burst:burst-gradle-plugin:2.12.1")
  }
}
```
...
| Kotlin          | Burst           |
|-----------------|-----------------|
| 2.4.0-beta1     | 2.13.0-beta1    |
| 2.3.20          | 2.12.0 - 2.12.1 |
| 2.3.0 - 2.3.10  | 2.11.0          |
